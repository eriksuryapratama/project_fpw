        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card border-0 shadow rounded-3 my-5" style="background-color:white">
                <div class="card-body p-4 p-sm-5">
                    <h5 class="card-title text-center mb-5 fw-light fs-5" style="font-family: 'Langar', cursive;font-family: 'Russo One', sans-serif;color:black;">Konfirmasi Retur</h5>

                    <form action="/pegawai/retur" method="POST">
                        @csrf
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="text" name="jumlah" class="form-control" id="" value="{{$result->jumlah}}" readonly>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="" style="color: black">Nama Supplier</label>
                            <input type="hidden" name="kode_supplier" class="form-control" id="" value="{{$result->daftarsupplier->kode_supplier}}" readonly>
                            <input type="text" name="supplier" class="form-control" id="" value="{{$result->daftarsupplier->nama_supplier}}" readonly>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="" style="color: black">Alasan Retur</label>
                            <input type="text" name="alasan" class="form-control" id="" placeholder="Masukkan alasan retur...">
                        </div>
